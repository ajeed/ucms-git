...
<div class="nav-outer">
		...
		<div id="nav-right">
			...
			<div class="nav-divider">&nbsp;</div>
			<a href="" id="logout"><img src="img/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
		...
		<ul class="select"><li><a href="#nogo"><b>Dashboard <?php echo $title_for_layout; ?></b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="current"><li><a href="#nogo"><b>Inventory</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
