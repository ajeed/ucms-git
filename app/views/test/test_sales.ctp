...
<div class="sales index">
	...
	<form id="StoreTestSalesForm" method="post" action="/ucms/test/testSales" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>
